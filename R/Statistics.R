##'Statistic methods for \code{"PomNet"} class.
##'
##'
##'These are the implementation for the basic statistic calculation methods.
##'
##'
##'@name Statistic.PomNode
##'@aliases Statistic.PomNode PnodeEAP,PomNet,PomNode-method
##'PnodeEAP,PomNet,character-method PnodeSD,PomNet,PomNode-method
##'PnodeSD,PomNet,character-method PnodeMargin,PomNet,PomNode-method
##'PnodeMargin,PomNet,character-method PnodeMedian,PomNet,PomNode-method
##'PnodeMedian,PomNet,character-method PnodeMode,PomNet,PomNode-method
##'PnodeMode,PomNet,character-method
##'@docType class
##'@section Methods:
##'
##'All methods have signature \code{signature(net = "PomNet", node =
##'"PomNode")} and \code{signature(net = "PomNet", node = "character")}.
...
setMethod("PnodeMargin",c("PomNet","PomNode"),
          function(net,node) {
              stop("Function Not Implemented")
              NodeBeliefs(node)
          })
setMethod("PnodeMargin",c("PomNet","character"),
          function(net,node) {
              stop("Function Not Implemented")
...
setMethod("PnodeEAP",c("PomNet","PomNode"),
          function(net,node) {
              stop("Function Not Implemented")
              c(NodeExpectedValue(node)) #clear SD attribute c()
              })
setMethod("PnodeEAP",c("PomNet","character"),
          function(net,node) {
              stop("Function Not Implemented")
            nd <- NetworkFindNode(net,node)
            if (!is.PomNode(nd))
...
setMethod("PnodeSD",c("PomNet","PomNode"),
          function(net,node) {
              stop("Function Not Implemented")
...
setMethod("PnodeSD",c("PomNet","character"),
          function(net,node) {
              stop("Function Not Implemented")
            nd <- NetworkFindNode(net,node)
            if (!is.PomNode(nd))
...
setMethod("PnodeMedian",c("PomNet","PomNode"),
          function(net,node)
              stop("Function Not Implemented")
            names(which(cumsum(NodeBeliefs(node))>=.5))[1])
setMethod("PnodeMedian",c("PomNet","character"),
          function(net,node) {
              stop("Function Not Implemented")
            nd <- NetworkFindNode(net,node)
            if (!is.PomNode(nd))
...
setMethod("PnodeMode",c("PomNet","PomNode"),
          function(net,node){
              stop("Function Not Implemented")
              names(which.max(NodeBeliefs(node)))
          })
setMethod("PnodeMode",c("PomNet","character"),
          function(net,node) {
              stop("Function Not Implemented")
            nd <- NetworkFindNode(net,node)
            if (!is.PomNode(nd))
