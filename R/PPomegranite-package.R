...
##'"PPomegranite")\Sexpr{tools:::Rd_package_title("PPomegranite")}
##'
##'c("\\Sexpr[results=rd,stage=build]{tools:::Rd_package_description(\"#1\")}",
##'"PPomegranite")\Sexpr{tools:::Rd_package_description("PPomegranite")}
##'
##'
...
##'\code{\link{Pnet.PomNet}} extends \code{\link[RNetica]{PomNet}} and
##'\code{\link{Pnode.PomNode}} extends \code{\link[RNetica]{PomNode}}.
...
##'\code{\link[RNetica]{PomNet}} (\code{\link[RNetica]{PomNode}}) merely
##'adds \dQuote{Pnet} (\dQuote{Pnode}) to \code{class(net)}
##'(\code{class(node)}).  All of the methods in the \code{PPomegranite} are defined
##'for either the \code{\link[RNetica]{PomNet}} or
##'\code{\link[RNetica]{PomNode}} object, so strictly speaking, adding the
##'\dQuote{Pnet} or \dQuote{Pnode} class is not necessary, but it is
##'recommended in case this is used in the future.
##'
##'@name PPomegranite-package
##'@aliases PPomegranite-package PPomegranite
##'@docType package
##'@section PPomegranite Specific Implementation Details:
##'
...
##'\code{\link[=Pnet.PomNet]{PnetPnodes}} stores its value in a nodeset
...
##'of the \code{\link{Pnet.PomNet}} object and all of the fields of the
##'\code{\link{Pnode.PomNode}} are stored in serialized user fields with
...
##'"PPomegranite")\Sexpr{tools:::Rd_package_author("PPomegranite")}
##'
##'Maintainer:
##'c("\\Sexpr[results=rd,stage=build]{tools:::Rd_package_maintainer(\"#1\")}",
##'"PPomegranite")\Sexpr{tools:::Rd_package_maintainer("PPomegranite")}
##'@seealso
##'
##'\code{PPomegranite} depends on the following other packages.  \describe{
